"""
Django settings for farm_site project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-y2lg*y2&c1)$j5x@$=md^u$rym&8e+woaer_z#8c45$1_na_ov')
...
WSGI_APPLICATION = 'farm_site.wsgi.application'
